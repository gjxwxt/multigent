...
func greenfieldDeliveryTemplate(locale string) entity.WorkflowTemplate {
	...
	return templateFromParts("greenfield-delivery-pipeline", text["name"], text["description"], locale, "requirement_draft",
		[]entity.WorkflowStep{
			...
			tmplStep("pr_open_and_merge", "agent_task", text["prMergeTitle"], text["prMergeDesc"], "owner-engineer", "violet", 2320,
			...
			tmplStep("release", "agent_task", text["releaseTitle"], text["releaseDesc"], "owner-engineer", "emerald", 2600,
