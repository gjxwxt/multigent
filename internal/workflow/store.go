...
func unifiedDeliveryPipelineTemplate(locale string) entity.WorkflowTemplate {
	...
	text := localizedTemplateText(locale, map[string]string{
		...
		"approvedScopeField": "Approved scope with acceptance criteria.",
		...
		"approvedChangeField":"Human-approved code artifact.",
		...
		"candidateField":     "Approved release candidate: branch/commit/tag reference.",
		...
		"decisionField":      "approve 或 request_changes。",
		"commentsField":      "审核意见与澄清说明。",
		"approvedScopeField": "已批准的范围与验收标准。",
		...
		"approvedChangeField":"人工审核通过的代码产物。",
		...
		"candidateField":     "已批准的发布候选：分支/提交/Tag 引用。",
